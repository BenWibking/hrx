...
#ifndef LOOM_TOOLING_TARGET_WASM_CHECK_LOOM_CHECK_H_
#define LOOM_TOOLING_TARGET_WASM_CHECK_LOOM_CHECK_H_
...
#endif  // LOOM_TOOLING_TARGET_WASM_CHECK_LOOM_CHECK_H_
