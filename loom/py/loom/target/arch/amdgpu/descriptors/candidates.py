...
_ATOMIC_KIND = {
    ...
    "max.i64": (AmdgpuAtomicKind.MAXSI, AmdgpuAtomicValueKind.I64),
    "min.u64": (AmdgpuAtomicKind.MINUI, AmdgpuAtomicValueKind.I64),
    "max.u64": (AmdgpuAtomicKind.MAXUI, AmdgpuAtomicValueKind.I64),
